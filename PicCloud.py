...
while True:
    ...
    timeStampString = datetime.datetime.now().strftime("%A_%Y-%m-%d_%I:%M_%p")
    ...
    if(GPIO.input(sw) == 0):
    	...
    	print "Save success!"
    	print "====================="
    	print "Uploading please moment..."
    	photo = "Dropbox-Uploader/dropbox_uploader.sh upload %s.jpg %s.jpg" % (timeStampString, timeStampString)
